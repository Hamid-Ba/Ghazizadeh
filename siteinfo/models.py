...
class Ticket(models.Model):
    ...
    phone = models.CharField(max_length=11, null=False, blank=False, verbose_name="موبایل")
...
class HomeHeader(models.Model):
    ...
    heading = models.CharField(max_length=72, null=True, blank=True, verbose_name="سر تیتر")
    paragraph = models.CharField(max_length=300, null=True, blank=True, verbose_name="توضیح تیتر")
...
class Footer(models.Model):
    ...
    heading = models.CharField(max_length=72, null=True, blank=True, verbose_name="تیتر")
    paragraph = models.CharField(max_length=300, null=True, blank=True, verbose_name="پاراگراف")
...
class SliderAndBanner(models.Model):
    ...
    heading = models.CharField(max_length=100, null=True, blank=True,verbose_name="تیتر")
    paragraph = models.CharField(max_length=125, null=True, blank=True,verbose_name="پاراگراف")
    link_text = models.CharField(max_length=72, null=True, blank=True,verbose_name="متن لینک")
...
class EmailAndPhone(models.Model):
    ...
    phone1 = models.CharField(max_length=17, null=True, blank=True, verbose_name="شماره تماس اول")
    phone2 = models.CharField(max_length=17, null=True, blank=True, verbose_name="شماره تماس دوم")
