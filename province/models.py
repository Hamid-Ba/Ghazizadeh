...
class Province(models.Model):
    ...
    slug = models.SlugField(max_length=125, blank=False, null=False, verbose_name="اسلاگ")
...
class City(models.Model):
    ...
    slug = models.SlugField(max_length=225, blank=False, null=False, verbose_name="اسلاگ")
    province = models.ForeignKey(
        Province, null=False, blank=False, on_delete=models.CASCADE, verbose_name="استان"
    )
